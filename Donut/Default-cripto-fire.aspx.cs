...
public partial class _Default : System.Web.UI.Page
{
    ...
    public static string genereteScore(string toEncrypt)
    {
        ...
        toEncrypt = Convert.ToString(toEncrypt.Split('|')[0]);
    ...
    [System.Web.Services.WebMethod]
    public static string genereteScorePlus(string toEncrypt)
    {
        if (string.IsNullOrEmpty(toEncrypt))
        {
            toEncrypt = "0|@d0XmyNET";
        }
        else
        {
            toEncrypt = Decrypt(toEncrypt);
            toEncrypt = Convert.ToString(Convert.ToInt64(toEncrypt.Split('|')[0]) + 1) + "|" + Convert.ToString(toEncrypt.Split('|')[1]);
        }
